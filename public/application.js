...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gamePlay = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var player1 = __webpack_require__(5);
	var player2 = __webpack_require__(6);
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  if (player1.user.id !== 0) {
	    var title = 'Danger Will Robinson';
	    var body = 'User is are already signed in.  Please sign-out';
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  if (player1.user.id === 0 && player2.user.id === 0) {
	    var title = 'Danger Will Robinson';
	    var body = 'Player is already signed out.  Please sign in to play';
	    $('#alert-modal-title').html(title);
	    $('#alert-modal-body').html(body);
	    $('#alert-modal').modal('show');
	    return;
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  if (player1.user.id === 0 && player2.user.id === 0) {
	    var title = 'Danger Will Robinson';
	    var body = 'Player is not signed in.  You must be signed in to change your password';
	    $('#alert-modal-title').html(title);
	    $('#alert-modal-body').html(body);
	    $('#alert-modal').modal('show');
	    return;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpFailure = function signUpFailure(error) {
	  ...
	  var title = 'Danger Will Robinson';
	  var body = 'Error with sign-up -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};
	...
	var signInFailure = function signInFailure(error) {
	  ...
	  var title = 'Danger Will Robinson';
	  var body = 'Error with sign-in -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};
	...
	var signOutFailure = function signOutFailure(error) {
	  ...
	  var title = 'Danger Will Robinson';
	  var body = 'Error with sign-out -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};
	...
	var changePasswordFailure = function changePasswordFailure(error) {
	  ...
	  var title = 'Danger Will Robinson';
	  var body = 'Error with changing password -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var player1 = __webpack_require__(5);
	// const game = require('../game.js')
	var currentMove = __webpack_require__(18);
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  if (player1.user.id === 0) {
	    ...
	    var title = 'Danger Will Robinson';
	    var body = 'Player 1 must be signed in before creating a new game';
	    $('#alert-modal-title').html(title);
	    $('#alert-modal-body').html(body);
	    $('#alert-modal').modal('show');
	    return;
	  ...
	  api.createGame().done(ui.createGameSuccess).fail(ui.CreateGameFailure);
	};

	var onMyStats = function onMyStats() {
	  // event.preventDefault()
	  ...
	  if (player1.user.id === 0) {
	    ...
	    var title = 'Danger Will Robinson';
	    var body = 'Player 1 must be signed in before getting their stats';
	    $('#alert-modal-title').html(title);
	    $('#alert-modal-body').html(body);
	    $('#alert-modal').modal('show');
	    return;
	  ...
	  api.myStats(currentMove).done(ui.myStatsSuccess).fail(ui.myStatsFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateMove = function updateMove(inData) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createGameFailure = function createGameFailure(error) {
	  ...
	  var title = 'Danger Will Robinson';
	  var body = 'Error with creating a new game -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};

	var updateMoveSuccess = function updateMoveSuccess(data) {
	  // console.log('here is the game after an update move was issued', game)
	};

	var updateMoveFailure = function updateMoveFailure(error) {
	  // console.error('createGameFailiure log', error)
	  var title = 'Danger Will Robinson';
	  var body = 'Error with move update for the game -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};

	var myStatsSuccess = function myStatsSuccess(data) {
	  // console.log('here is the result of myStatsSuccess ', data)

	  var gameRecord = getWins(data);
	  // console.log('here is the game record: ', gameRecord)
	  var title = 'Here are your game stats';
	  var body = gameRecord;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	...
	var myStatsFailure = function myStatsFailure(error) {
	  // console.error('myStatsFailiure log', error)
	  var title = 'Danger Will Robinson';
	  var body = 'Error with my Stats.  Sorry bud -- ' + error.statusText;
	  $('#alert-modal-title').html(title);
	  $('#alert-modal-body').html(body);
	  $('#alert-modal').modal('show');
	};

	var getWins = function getWins(data) {
	...
	module.exports = {
	  ...
	  updateMoveFailure: updateMoveFailure,
	  myStatsSuccess: myStatsSuccess,
	  myStatsFailure: myStatsFailure,
	  getWins: getWins
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameStatus = function gameStatus() {
	  ...
	  var xPos = [];
	  var oPos = [];
	  for (var i = 0; i < game.game.cells.length; i++) {
	...
	var winnerWinner = function winnerWinner(data) {
	...
	var buildCurrentMove = function buildCurrentMove(boxNumber, player, gameStatus) {
	...
	var updtGame = function updtGame() {
	  // event.preventDefault()
	  // const data = getFormFields(event.target)
	  api.updateMove(currentMove).done(ui.updateMoveSuccess).fail(ui.updateMoveFailure);
	};
